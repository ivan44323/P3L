  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            <form class="form-horizontal form-label-left" action="<?php echo site_url('KendaraanCustomer/edit');?>" method="post">
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">No Polisi</label>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="no_polisi" class="form-control col-md-7 col-xs-12" name="no_polisi" value="<?php echo $kendaraancustomer_edit->no_polisi ?>">
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-9 col-xs-12">
                  <select class="form-control" name="id_customer">
                    ...
                    <?php foreach($kendaraancustomer_customer as $kendaraancustomer_customer): ?>
                      <option value="<?php echo $kendaraancustomer_customer->id_customer; ?>" <?php if($kendaraancustomer_customer->id_customer==$kendaraancustomer_edit->id_customer) { ?> selected="selected" <?php } ?>><?php echo $kendaraancustomer_customer->nama_customer; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-9 col-xs-12">
                  <select class="form-control" name="id_type">
                    ...
                    <?php foreach($kendaraancustomer_type_motor as $kendaraancustomer_type_motor): ?>
                      <option value="<?php echo $kendaraancustomer_type_motor->id_type; ?>" <?php if($kendaraancustomer_type_motor->id_type==$kendaraancustomer_edit->id_type) { ?> selected="selected" <?php } ?>><?php echo $kendaraancustomer_type_motor->nama_type; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
