  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            <form class="form-horizontal form-label-left" action="<?php echo site_url('Transaksi/edit');?>" method="post">
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">ID Transaksi</label>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="id_transaksi" class="form-control col-md-7 col-xs-12" name="id_transaksi" value="<?php echo $transaksi_edit->id_transaksi ?>" readonly="readonly">
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="qty_transaksi" class="form-control col-md-7 col-xs-12" name="qty_transaksi" value="<?php echo $transaksi_edit->qty_transaksi ?>">
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="total_transaksi" class="form-control col-md-7 col-xs-12" name="total_transaksi" value="<?php echo $transaksi_edit->total_transaksi ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-2 col-sm-9 col-xs-12">
                  <select class="form-control" name="id_sparepart">
                    ...
                    <?php foreach($sparepart_nama as $sparepart_nama): ?>
                      <option value="<?php echo $sparepart_nama->id_sparepart; ?>" <?php if($sparepart_nama->id_sparepart==$transaksi_edit->id_sparepart) { ?> selected="selected" <?php } ?>><?php echo $sparepart_nama->nama_sparepart; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-9 col-xs-12">
                  <select class="form-control" name="id_jasa_service">
                    ...
                    <?php foreach($jasaservice_nama as $jasaservice_nama): ?>
                      <option value="<?php echo $jasaservice_nama->id_jasa_service; ?>" <?php if($jasaservice_nama->id_jasa_service==$transaksi_edit->id_jasa_service) { ?> selected="selected" <?php } ?>><?php echo $jasaservice_nama->nama_jasa; ?></option>                   
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-9 col-xs-12">
                  <select class="form-control" name="id_pegawai">
                    ...
                    <?php foreach($pegawai_nama as $pegawai_nama): ?>
                      ...
                      <option value="<?php echo $pegawai_nama->id_pegawai; ?>" <?php if($pegawai_nama->id_pegawai==$transaksi_edit->id_pegawai) { ?> selected="selected" <?php } ?>><?php echo $pegawai_nama->nama_pegawai; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="id_detail_transaksi" class="form-control col-md-7 col-xs-12" name="id_detail_transaksi" value="<?php echo $transaksi_edit->id_detail_transaksi ?>" readonly="readonly">
                </div>
              </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <?php foreach($polisi_no as $polisi_no): ?>
                      ...
                      <option value="<?php echo $polisi_no->no_polisi; ?>" <?php if($polisi_no->no_polisi==$transaksi_edit->no_polisi) { ?> selected="selected" <?php } ?>><?php echo $polisi_no->no_polisi; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
