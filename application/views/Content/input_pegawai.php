  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            <form class="form-horizontal form-label-left" action="<?php echo site_url('Pegawai/insert');?>" method="post">
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">ID Customer</label>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="id_pegawai" class="form-control col-md-7 col-xs-12" name="id_pegawai">
                </div>
              </div>
                ...
                <div class="col-md-2 col-sm-9 col-xs-12">
                  <select class="form-control" name="id_role">
                    ...
                    <?php foreach($pegawai_role as $pegawai_role): ?>
                      <option value="<?php echo $pegawai_role->id_role; ?>"><?php echo $pegawai_role->nama_role; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
              ...
              <!-- <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Role</label>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="id_role" class="form-control col-md-7 col-xs-12" name="id_role">
                </div>
              </div> -->
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <input type="text" id="id_role" class="form-control col-md-7 col-xs-12" name="nama_pegawai">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <textarea id="alamat_pegawai" class="form-control" name="alamat_pegawai"></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <input type="text" id="telepon_pegawai" class="form-control col-md-7 col-xs-12" name="telepon_pegawai">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <input type="text" id="Gaji" class="form-control col-md-7 col-xs-12" name="gaji_pegawai">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                  <input type="text" id="username" class="form-control col-md-7 col-xs-12" name="username">
                </div>
              </div>
