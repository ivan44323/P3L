  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_content">
            <form class="form-horizontal form-label-left" action="<?php echo site_url('Sparepart/insert');?>" method="post">
              
              <!--<div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">ID Sparepart</label>
                <div class="col-md-2 col-sm-6 col-xs-12">
                  <input type="text" id="id_sparepart" class="form-control col-md-7 col-xs-12" name="id_sparepart">
                </div>
              </div>-->
                ...
                <div class="col-md-2 col-sm-9 col-xs-12">
                  <select class="form-control" name="id_type_sparepart">
                    ...
                    <?php foreach($sparepart_type as $sparepart_type): ?>
                      <option value="<?php echo $sparepart_type->id_type_sparepart; ?>"><?php echo $sparepart_type->nama_type_sparepar; ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div>
